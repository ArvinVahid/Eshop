        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryToProducts_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "لوازم ورزشی", "لوازم ورزشی" },
                    { 3, "لوازم منزل", "لوازم منزل" },
                    { 4, "ساعت مچی", "ساعت مچی" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CategoryId", "ProductId", "ItemId" },
                values: new object[,]
                {
                    { 1, 1, null },
                    { 2, 1, null },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryToProducts_ItemId",
                table: "CategoryToProducts",
                column: "ItemId");
